    ...
    async with db.acquire() as conn, conn.transaction():
        ...
        await conn.executemany(
            """INSERT INTO subnet_price_samples
               (time,block_number,block_hash,netuid,price_tao,tao_reserve,alpha_reserve,alpha_out,alpha_issuance,volume_tao,
            ...
            [(timestamp, number, block_hash, r["netuid"], r["price_tao"], r["tao_reserve"],
              r["alpha_reserve"], r["alpha_out"], r["alpha_issuance"], r["volume_tao"], r["tao_in_emission"],
