...
export type View = 'home' | 'overview' | 'ainews' | 'cryptonews' | 'videos' | 'aicoins' | 'cryptocoins' | 'all-shorts' | 'all-stories' | 'research' | 'defi' | 'bubbles' | 'tools' | 'contact' | 'bittensor' | 'send-tip' | 'portfolio' | 'all-comments';
