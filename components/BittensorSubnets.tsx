...
const SUBNETS_DATA: Subnet[] = [
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is noise. Three version bumps with zero merged PRs and no visible feature work is the opposite of a signal. At $11.4M mcap with a flat token, the team should be shipping real capability or fixing real problems—not spinning version numbers.",
      marketCap: "$11.6M",
      aGapScore: 57
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is noise masquerading as progress. Reverting a check that was working doesn't change the fact that this is a $39M subnet shipping configuration tweaks while the top end of the market moves on to actual model releases. Low conviction on code that just toggles parameters.",
      marketCap: "$39.5M",
      aGapScore: 24
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Numinous is trading at a $5.6M valuation with a token down 5.3% today while the team ships nothing—not even a real PR, just automated plumbing. This is a sign the team is on maintenance mode, not building. Stay away until you see a genuine product commit.",
      marketCap: "$5.7M",
      aGapScore: 54
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Pure noise. A $4.4M mcap subnet with zero merged PRs and one contributor touching a timer and a README is dead air. Until there's actual model development or performance gains, this is just another slot-warming token.",
      marketCap: "$4.4M",
      aGapScore: 18
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is noise dressed as activity. Shipping only documentation changes signals stalling engineering momentum. Positioned as an 'RL playground,' but the lack of functional commits + token decline suggests the subnet is treading water. The problem isn't underappreciation, it's underperformance.",
      marketCap: "$13.0M",
      aGapScore: 56
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine maintenance work by a skeleton crew. Removing vulnerability scanning from CI is a negative signal for a compute subnet. At $6.4M mcap with no PR activity, the team is in stabilization mode. Market is pricing this correctly as early-stage infrastructure with minimal near-term upside.",
      marketCap: "$6.4M",
      aGapScore: 18
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Data Universe is shipping protocol-level anti-fraud infrastructure. Miners now have to run legitimate operations or get zeroed, which significantly raises the subnet's barrier to entry and data quality. This is the unglamorous work that makes a data subnet truly valuable at scale.",
      marketCap: "$9.1M",
      aGapScore: 69
    }
  },
  {
    ...
    details: {
      ...
      alphaGapTake: "Noise only. Pushing version numbers with zero accompanying code changes is the hallmark of 'release theater' for small-cap subnets. TAOHash remains a high-risk, low-information play until we see actual merged features that justify the $12M valuation.",
      marketCap: "$12.4M",
      aGapScore: 31
    }
  },
  {
    ...
    details: {
      ...
      alphaGapTake: "This is solid, necessary work that should have been done weeks ago. Fixing a correctness bug in the reward-scoring path is material for validator trust. However, it's defensive engineering—fixing broken things, not building new ones. At $3.4M mcap with token down 8.9%, the team is executing competently but shipping incremental quality improvements.",
      marketCap: "$3.4M",
      aGapScore: 58
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Competent hygiene, but invisible to the market. Fixing retries is engineering 101 for a high-traffic inference network. It shows the team is maintaining the pipes, but it doesn't solve the discovery problem for Zeus as an institutional tool.",
      marketCap: "$2.1M",
      aGapScore: 38
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine housekeeping. Changing prompts is not a technical breakthrough—it's a content adjustment. At $1.4M mcap, they are just polishing a tool that hasn't yet found product-market fit.",
      marketCap: "$1.4M",
      aGapScore: 45
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Pure maintenance noise. Debugging logs on a $0.8M mcap token is 'keeping the lights on' territory. There is no evidence here of new features, scaling, or adoption. The team is still in the sandbox.",
      marketCap: "$843K",
      aGapScore: 32
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Desearch is shipping protocol-level improvements that solve Bittensor's most painful scaling problem: multi-UID spam. The organic weighting means the leaderboard now reflects real user demand, moving Desearch from a toy ranking system to a real search engine.",
      marketCap: "$5.5M",
      aGapScore: 78
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Beqar is shipping real infrastructure defenses like DDoS resistance and tokenized access control—table-stakes for any production scraper. If this works at scale, Beqar becomes the only viable decentralized competitor to centralized scraping APIs.",
      marketCap: "$4.9M",
      aGapScore: 23
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is noise. A one-line CLI cosmetic fix at a $15M subnet with a flat token is not an investment signal—it's routine maintenance. The market has already priced in 'this team keeps the lights on.' Watch for actual new model releases or detection accuracy breakthroughs to get bullish.",
      marketCap: "$14.8M",
      aGapScore: 38
    }
  },
  ...
  { 
    ...
    details: {
      ...
      recentUpdates: ["Adversarial loop v3", "Verifiable safety reporting"]
    }
  },
  { 
    sn: 38, 
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Almanac is performing solid operational engineering. The implementation of cursor-based pagination directly improves data throughput, signaling that the team is thinking about scaling constraints before they hit a wall. Fixed scoring logic and reward boosts address basic subnet stability.",
      marketCap: "$5.1M",
      aGapScore: 40
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is a red flag wrapped as a signal. A 100% burn commit with zero team discussion and zero shipping of actual real estate models smells like financial desperation or governance theater, not product momentum. Skipping until real model improvements appear.",
      marketCap: "$7.0M",
      aGapScore: 35
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine maintenance work on a $0.6M micro-cap token that's down 3%. The commits are competent but unglamorous bug fixes. There's no signal of product velocity, team expansion, or breakthrough capability here. The market isn't sleeping on EvolAI; it's barely awake.",
      marketCap: "$580K",
      aGapScore: 37
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine bug maintenance on a $10M subnet. Missing price data in a financial prediction system breaks accuracy; this restores data integrity but is foundational maintenance, not a leap forward. The market is correctly pricing in steady operational work.",
      marketCap: "$10.1M",
      aGapScore: 64
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine DevOps plumbing—necessary but not novel. Infrastructure bug fixes are already baked into expectations—they're not surprising upside. The team is heads-down fixing stability issues, which is good for long-term health but provides no near-term investment catalyst.",
      marketCap: "$52.0M",
      aGapScore: 77
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is pure noise. Two commits with no substance, zero merged PRs, and a token price that's essentially flat while the team ships nothing visible. Hard pass until they ship something real—biometric synthesis v1 was an incremental step, but prompt toggling is not.",
      marketCap: "$7.9M",
      aGapScore: 48
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "NIOME is shipping routine maintenance on a $3M subnet with single-contributor commits. There's no evidence of product momentum, user adoption, or differentiation. The team is debugging validator plumbing while competitors are shipping features.",
      marketCap: "$3.6M",
      aGapScore: 38
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid internal infrastructure work, but it's invisible to the market. Tournament-style evaluation is table-stakes for AutoML robustness; this suggests they're building more rigorous validator infrastructure. However, the market isn't reacting to plumbing.",
      marketCap: "$23.1M",
      aGapScore: 75
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine noise at a critical moment. Sparket is a $3.6M mcap project with zero price momentum and a version bump with zero accompanying documentation. The team isn't communicating progress to the market. Score reflects maintenance activity, not investment-grade shipping.",
      marketCap: "$3.5M",
      aGapScore: 34
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine operational governance—a single commit touching incentive weights. A shift toward arena-based rewards could improve quality discovery, but this is an operational tuning, not a breakthrough. The team is alive but this signal is noise until they ship real model improvements.",
      marketCap: "$4.8M",
      aGapScore: 28
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine maintenance work with zero investment signal. Shipping only bug fixes and version bumps—with zero merged PRs—suggests either the team is dormant between sprints or development velocity has stalled. The market is correctly pricing in 'nothing shipped.'",
      marketCap: "$4.3M",
      aGapScore: 60
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Log stream reliability is table-stakes infrastructure; fixing retries reduces dropped logs and improves observability. However, this is routine maintenance, not a step forward in capability. At $98M mcap, the market has already priced in slow and steady.",
      marketCap: "$98.5M",
      aGapScore: 54
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Dead signal. A $4.4M mcap token merging a ghost commit with zero context. The team may be working, but this commit proves nothing shipped. Until we see actual PRs with features or usage metrics, this subnet is trading on narrative alone.",
      marketCap: "$4.4M",
      aGapScore: 32
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine maintenance on a tiny, flat-lined token. A config parameter bump tells us the team is still iterating on training infrastructure, but there's zero signal of a shipped feature, new capability, or market-moving release. It's currently in pre-product grinding mode.",
      marketCap: "$12.4M",
      aGapScore: 28
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is maintenance work, not growth. A single retry commit with zero merged PRs on a $200K mcap token screams 'slow week'—not 'sleeping giant.' Harnyx has shipped the same research-as-commodity vision for months; today's commit is polishing the UX, not expanding the TAM.",
      marketCap: "$331K",
      aGapScore: 46
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "NOVA is dead air. A $17M market cap subnet with one contributor touching internal metrics while the token treads water is a red flag. Metric direction fixes are necessary but not building a new feature—it's correcting something already broken. Market is correctly pricing this as invisible.",
      marketCap: "$16.9M",
      aGapScore: 54
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is tokenomics theater masquerading as development. A single burn commit from one contributor at a $0.3M mcap with zero feature velocity is a red flag. The team is tinkering with economics instead of shipping product. NexisGen is not on any serious investor's radar.",
      marketCap: "$329K",
      aGapScore: 53
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid maintenance on a high-risk domain. Key rotation security is invisible but vital for B2B subnets. However, at $6M mcap and zero price volatility, this doesn't move the needle on investment thesis—it just prevents a catastrophe.",
      marketCap: "$6.0M",
      aGapScore: 52
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "StreetVision is building physical AI plumbing. Synthetic data quality is the king-maker in AV training; NATIX is addressing model reliability and false positives directly, which is table-stakes for enterprise customer trust.",
      marketCap: "$3.6M",
      aGapScore: 54
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Maintenance-tier work, but necessary for a bridging subnet. Speeding up transaction finality marginally improves UX, which is the only thing that matters for MetaHash. Positive but incremental signal for their 2,500+ daily active users.",
      marketCap: "$15.9M",
      aGapScore: 74
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is pure noise. A $0.1M mcap subnet with zero actual features shipped and configuration-only commits does not justify investment attention. Threshold tuning and hotkey management are table-stakes housekeeping. Come back when there's actual voice model development or performance gains.",
      marketCap: "$129K",
      aGapScore: 10
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is pure noise. A $5M market cap team pushing version bumps with zero merged work suggests either internal restructuring or stalled development masked by release theater. The token pump is likely disconnected from any shipped value. Skip until you see 3+ merged PRs with real capability.",
      marketCap: "$4.8M",
      aGapScore: 31
    }
  },
  { 
    ...
    details: {
      ...
      recentUpdates: ["Merged-mining v2", "AI reward weighting optimized"]
    }
  },
  { 
    sn: 82, 
    ...
    details: {
      ...
      alphaGapTake: "Dead air. A $1.7M market-cap project with zero code updates and documenting a release that happened weeks ago. No investment signal here—only the risk of holding an abandoned asset while the rest of the ecosystem innovates.",
      marketCap: "$1.7M",
      aGapScore: 15
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is noise masquerading as development. A single dependency bump on a $3M, flat-token subnet signals minimal active growth. While the 700-vertex graph escalation is respectable engineering, the overall velocity is too low to justify conviction. Market is correctly indifferent.",
      marketCap: "$3.1M",
      aGapScore: 20
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine infrastructure maintenance—necessary but not innovative. Timeout syncing is table-stakes reliability work. ChipForge needs to prove it can actually coordinate real hardware validation at scale before investors care. Right now this is noise masquerading as work.",
      marketCap: "$2.7M",
      aGapScore: 52
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Pure noise. A single work-interval adjustment on a $4M mcap PoW subnet is routine maintenance at best. There is no evidence of adoption, institutional mining interest, or breakthrough security primitives. Hammer is currently just another PoW-clone treading water.",
      marketCap: "$4.1M",
      aGapScore: 10
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Dead weight. A $0.6M market-cap project with README edits and one contributor. No evidence of actual development, model training, or validator improvements. This is either a zombie project or extremely early pre-alpha. No investment signal here—only downside risk.",
      marketCap: "$637K",
      aGapScore: 51
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is maintenance-tier work, not market-moving. A single parameter adjustment to a data window is routine infrastructure tuning. With zero merged PRs and flat token price, this subnet shows neither shipping velocity nor market traction. Not a signal.",
      marketCap: "$3.9M",
      aGapScore: 72
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine maintenance and configuration work. Adding token verification is a quality-of-life fix for users, but it doesn't change the underlying project economics or adoption. The market is waiting for a blockbuster subnet launch to validate Bitstarter's utility.",
      marketCap: "$20.3M",
      aGapScore: 43
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid utility. Multi-wallet support is the final piece of the puzzle for institutional miner adoption of TensorClaw. It's unsexy middleware that solves the 'too many keys' problem for large operators. Bullish on adoption velocity.",
      marketCap: "$4.1M",
      aGapScore: 52
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Dead signal. Updating a distribution script is a routine back-office task. At an $11M valuation, the team is doing the bare minimum while the community is screaming for features. Sell the rally.",
      marketCap: "$11.0M",
      aGapScore: 18
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid technical progress on an abandoned play. The sync refactor shows someone is still in the machine room, but without a community or volume, these gains are academic. Buy if you believe in a 'V2' resurrection.",
      marketCap: "$1.4M",
      aGapScore: 68
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Knowledge distillation is the key to mobile and edge AI. Distil is solving the 'size problem' that prevents massive models from running locally. Fixed model-checking crashes directly impact network reliability and reward accuracy for these edge-case devices.",
      marketCap: "$7.2M",
      aGapScore: 60
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is competent infrastructure work, but it's not newsworthy for investors. Diversifying evaluators reducing single-point-of-failure risk is good engineering hygiene, but the core generation capability hasn't fundamentally changed. Low market capitalization reflects lack of unique IP.",
      marketCap: "$861K",
      aGapScore: 12
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid performance engineering. Sub-second latency is the 'holy grail' for real-time agents; without it, autonomous assistants are too slow for human use. This architectural fix unblocks actual productization of the subnet.",
      marketCap: "$4.1M",
      aGapScore: 52
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "InfiniteHash is executing a smart operational expansion. Adding BCH increases miner yields-per-watt, the primary growth driver for hardware subnets. Merged mining is an elegant way to steal hashrate from legacy pools into the Bittensor ecosystem.",
      marketCap: "$14.2M",
      aGapScore: 55
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "Djinn is shipping real privacy primitives. Encryption + Escrow makes this a professional signal marketplace, not just a leaderboard. This addresses the 'information leakage' problem that prevents top-tier traders from sharing signals.",
      marketCap: "$2.4M",
      aGapScore: 45
    }
  },
  ...
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is competent maintenance work on a broken incentive mechanism—exactly what should happen at this stage—but it's not a feature leap or breakthrough. Lip-sync duration fixes are literal plumbing work at a basement-valuation subnet.",
      marketCap: "$895K",
      aGapScore: 38
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is incremental but directionally correct. The websocket reversal is a yellow flag: it suggests the team is moving fast without full validation, resulting in wasted cycles. Performance-based routing is the right move for a $3.1M bandwidth network, but the revert erodes confidence.",
      marketCap: "$3.1M",
      aGapScore: 29
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid infrastructure work—real-time heartbeats solve the 'phantom miner' problem where validators waste time querying dead nodes. It's a professionalization step, but it doesn't move the needle on trading volume yet for a bridge with $1.4M market cap.",
      marketCap: "$1.4M",
      aGapScore: 23
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid, defensive engineering fixing a correctness bug in the reward path. Correctly scoring miners based on timestamp-accurate registration is literal table-stakes. It doesn't move the needle on discovery, but it stops the bleeding of quality miners leaving the subnet.",
      marketCap: "$534K",
      aGapScore: 12
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is competent engineering that every production system needs, but it's not a market catalyst. Robust retries and error handling are invisible to users but critical for uptime. The project is technically sound but needs a broader utility signal to break out from $1.1M.",
      marketCap: "$1.1M",
      aGapScore: 24
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is professional plumbing. As transaction volume scales, caching and connection pooling (Redis/DB) become the difference between a working DEX and a broken one. This signals that Minotaur is preparing for actual load and high-frequency intent solving.",
      marketCap: "$1.6M",
      aGapScore: 31
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid defensive work in a high-stakes niche. Peg stability is the only metric that matters for tUSD; hardening the liquidator and fixing oracle delay vulnerabilities are professional security moves. No feature leap, just building a safer vault.",
      marketCap: "$1.8M",
      aGapScore: 35
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid incremental maintenance with zero hype. The model switch to GPT-4o-mini signals cost-per-inference optimization, which is a pragmatism sign. Recovery hardening is the right move for bridging subnets but invisible to users. $1.4M mcap reflects low awareness.",
      marketCap: "$1.4M",
      aGapScore: 57
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is maintenance-tier activity fixing an execution bug. Correcting a scoring calculation that was penalizing miners for passing is necessary, but it's not innovation. The increased monitoring frequency allows for faster recovery from dead validators.",
      marketCap: "$1.2M",
      aGapScore: 26
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid, unglamorous maintenance work by a 2-person team. No new game integrations, no accuracy improvements—just fixing weight burn and sync bugs. The market is correctly ignoring it as non-material until the next 'Play' feature is released.",
      marketCap: "$1.3M",
      aGapScore: 28
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is competent protocol hardening. Using median-based scoring blocks the 'outlier exploit' common in early subnets. This shows the subnets team understands game theory and adversarial miners. Spoofing protection is a critical security fix for a $2.9M index.",
      marketCap: "$2.9M",
      aGapScore: 36
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid incremental work — engineering discipline on cycle times and scoring transparency — but it's not a feature leap. Institutional maintenance is necessary for its $52M mcap, and Pareto margin tuning signals sophisticated mathematical modeling of model evolution.",
      marketCap: "$52.7M",
      aGapScore: 74
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid plumbing work. Moving from polling to persistent TCP sockets is exactly what handles scaling challenges. It's unsexy work that saves money and improves reliability for developers. The marketplace UI update is purely cosmetic until real volume appears.",
      marketCap: "$4.1M",
      aGapScore: 31
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid maintenance work—not sexy, but necessary. Heartbeat fixes prevent legitimate miners from being disconnected improperly. The rejection filter addresses the 'copycat model' problem in recommendation tasks. Still awaiting a major retail partnership catalyst.",
      marketCap: "$2.2M",
      aGapScore: 28
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is solid incremental refinement of a core protocol. Shifting the reward exponent to increase 'competitive variance' is the kind of game-theory tuning that rewards the absolute best miners over average ones. Transaction tracing is critical for institutional auditability.",
      marketCap: "$4.9M",
      aGapScore: 18
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "This is routine infrastructure maintenance—necessary but not innovative. The team is fixing validator plumbing (timeouts, staleness) rather than shipping new capability. PyPI release is a positive sign for developer adoption, but market signal remains neutral.",
      marketCap: "$4.9M",
      aGapScore: 53
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid safety play. Collusion detection is the 'final boss' of onchain poker integrity; if Poker44 can reliably flag multi-accounting and botting, it becomes target-M&A territory for large gaming platforms. $1.1M mcap is a discovery-phase valuation.",
      marketCap: "$1.1M",
      aGapScore: 45
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Incremental but solid. Re-tuning the evolution loop for higher Sharpe-ratio targets shows the team understands institutional requirements. Most strategies are noise—Astrid is filtering for signal. At $0.8M mcap, it's a high-alpha/high-risk microcap.",
      marketCap: "$0.8M",
      aGapScore: 52
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid scaling logic. Relay latency is the bottleneck for decentralized CDNs; optimizing orchestration makes ByteLeap more competitive with centralized alternatives. It's a technical win that doesn't yet show up in the price, but makes the network foundation stronger.",
      marketCap: "$2.1M",
      aGapScore: 31
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Dead air. Documentation updates on a $6.4M subnet with zero code changes is noise. There is no evidence here of actual compute utility or volume.",
      marketCap: "$6.4M",
      aGapScore: 13
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Solid maintenance on a high-risk domain. Key rotation security is invisible but vital for auditability subnets. This doesn't change the valuation, but it prevents a disaster.",
      marketCap: "$2.9M",
      aGapScore: 41
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "A $24M market cap project shifting its scoring weight is interesting but incremental. Re-weighting replicability scores suggests the team is responding to feedback from researchers (likely SN67 partners). It preserves value but doesn't create a breakthrough yet.",
      marketCap: "$24.1M",
      aGapScore: 56
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Fixed offset is a minor operational correction. For a subnet dependent on real-time solar data, sync accuracy is binary—it's either right or useless. This fix moves them closer to 'right.' However, at $650k mcap, they are still a microscopic experiment.",
      marketCap: "$651K",
      aGapScore: 42
    }
  },
  { 
    ...
    details: {
      ...
      alphaGapTake: "Routine maintenance. Updating bridge keys is a required task for mainnet continuity, not a value-add. HashiChain remains the 'plumbing' that needs broad subnet adoption to be a real investment signal.",
      marketCap: "$1.4M",
      aGapScore: 31
    }
  },
                ...
                {selectedSubnet.details ? (
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                      ...
                      {selectedSubnet.details.alphaGapTake && (
                        <section className="space-y-4 p-6 bg-orange-500/5 rounded-[2rem] border border-orange-500/10">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-orange-600 dark:text-orange-400 font-bold uppercase tracking-tight">
                              ...
                              AlphaGap Strategic Take
                            </div>
                            {selectedSubnet.details.aGapScore && (
                              <div className="flex items-center gap-2 px-3 py-1 bg-orange-500 text-white rounded-full text-[10px] font-black tracking-widest">
                                AGAP SCORE: {selectedSubnet.details.aGapScore}
                              </div>
                            )}
                          </div>
                          ...
                          {selectedSubnet.details.marketCap && (
                            <div className="pt-4 border-t border-orange-500/10 flex items-center justify-between font-mono text-[10px] text-slate-500 uppercase tracking-widest">
                              <span>Sourced via AlphaGap Intelligence</span>
