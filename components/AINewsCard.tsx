  ...
  return (
    <div className="relative group flex flex-col h-full">
      <a 
        ...
        className="flex flex-col h-full bg-white dark:bg-[#1e293b]/20 rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/5 hover:border-orange-500/50 transition-all duration-500 shadow-sm hover:shadow-2xl dark:hover:bg-white/[0.04] active:scale-[0.98] cursor-pointer"
      >
        ...
        <div className="p-8 flex flex-col flex-grow bg-gradient-to-b from-transparent to-slate-50/30 dark:to-white/[0.01]">
          <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white leading-[1.15] mb-4 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors font-space italic uppercase tracking-tight">
            {item.title}
          </h3>
          ...
          <div className="flex items-center justify-between pt-6 border-t border-slate-200 dark:border-white/5">
            <span className="text-[10px] font-black text-orange-600 dark:text-orange-400 uppercase tracking-[0.3em] font-mono inline-flex items-center gap-2 group-hover:translate-x-1 transition-transform">
