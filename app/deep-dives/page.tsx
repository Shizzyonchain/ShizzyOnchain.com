...
export default function DeepDivesPage() {
  return <main className="deep-shell"><DeepDivesHeader />
    ...
    <section className="deep-feature">
      <Link className="deep-cover" href="/deep-dives/bittensor-v440"><Image src="/deep-dives/bittensor-v440.png" alt="Bittensor v440: The Emission Gate" width={1672} height={941} sizes="(max-width: 900px) 100vw, 55vw"/><span>Read the deep dive &rarr;</span></Link>
    ...
    <section className="deep-archive" aria-labelledby="more-deep-dives">
      ...
      <Link className="deep-archive-card" href="/deep-dives/compute-wars">
        <Image src="/deep-dives/compute-wars.png" alt="Compute Wars: Bittensor AI infrastructure" width={900} height={360} sizes="(max-width: 700px) 100vw, 40vw"/>
